...
### Reading in buoy data - 2021 - Waiting for Data (last checked 1/12/2021)
```{r}
channel_dat_2021_raw <- read.table("data_raw/2021_buoy_dat.txt", header = FALSE, 
                                   col.names = c("#YY","MM","DD","hh","mm",
                                                 "WDIR","WSPD","GST","WVHT",
                                                 "DPD","APD","MWD","PRES",
                                                 "ATMP","WTMP","DEWP","VIS",
...
flights_plus_channel_dat_2020 <- left_join(dat_2021, channel_dat_2021, by = "date_hour")
#View(flights_plus_channel_dat_2020)
