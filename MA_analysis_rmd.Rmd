...
### Recovery of clean daily_3yr_dat (so you don't have to re-run everything above if you mess it up)
```{r}
...
### Working version as of 7/4: day instead of month, CSULB or LTER sft data, total count
```{r}
...
#DE = 62.2, n = 249
#wvht penalized to zero, removal increases n to 252
visreg(lbgam_tot_full)

anova(lbgam_tot_full)
#year and vis significant parametrics, beaufort marginal
#hour sig in 2020 and 2021, not 2019
#day sig. in all years
#tide and sft significant
#wvht n.s.
#salinity marginal at p = 0.064
...
#DE = 58.4, n = 235
#DE of non-chl model = 62.2, n = 249
...
#day significant in 2019 and 2020, marginal in 2021
#tide and salinity significant
#chl p = 0.11
#sft and waveheight penalized to zero
...
#sft-only model (no tide, wvht, chl, or salinity) explains slightly MORE deviance than the model without sft and the global model

AICc(lbgam_sft_only, lbgam_tot_chl_no_sft, lbgam_tot_chl, lbgam_tot_full)
#but AIC is much higher, along with the model w/out chl

#It's clear that sft and chl are not getting along, which may make sense since they aren't super correlated with one another:
...
### Juvenile and Adult density models with CSULB sft data
```{r}
...
anova(lb_juv_gam)
#year and day (2019 and 2020) significant
#hour and day in 2021 marginal
#sft p = 0.1 
#wvht, salinity, and chl all penalized to zero

anova(lb_adult_gam)
#year, hour in 2019, day in 2020 significant
#tide and salinity significant
#hour in 2020 and day in 2021 marginal
#sft, wvht, and chl all penalized to zero
```
...
#hour only significant variable
