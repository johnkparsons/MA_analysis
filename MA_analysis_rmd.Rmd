...
## CSULB temp data (makes R crash - 5/12)
```{r}
#lb_temp_20 <- read.csv("data_raw/All_raw_temp_data_2020.csv")
#view(lb_temp_20)
```
...
### determining deviance explained of each term by dropping it from the global model - NEED TO RE-RUN ALL OF THIS for both local and regional models as of 5/12
...
#dat_3yr_length <- full_join(size_dat_2yr, size_dat_2021)
