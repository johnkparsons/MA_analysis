...
#set horizontal and vertical distance from UAV position to edge of FOV:
...
data.frame(str_remove(str_remove(filename, "data_raw/transect_csvs_2021/"), "_v2.csv"), area, duration, alt, alt_error)
}
